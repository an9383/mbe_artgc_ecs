...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=172.30.1.27;Database=RCMS;User Id=dev;Password=dev;TrustServerCertificate=true;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<TbEquipment>(entity =>
        {
            ...
            entity.Property(e => e.Lastupdateuserid)
                ...
                .HasComment("마지막수정자")
                .HasColumnName("LASTUPDATEUSERID");
            entity.Property(e => e.Spreaderoffset)
                .HasComment("Spreader 원점 Offset")
                .HasColumnName("SPREADEROFFSET");
        ...
        modelBuilder.Entity<TbJoborder>(entity =>
        {
            ...
            entity.Property(e => e.Fromlocationtype)
                .HasMaxLength(40)
                .IsUnicode(false)
                .HasComment("From Location Type")
                .HasColumnName("FROMLOCATIONTYPE");
            entity.Property(e => e.Fromlandtype)
                .HasMaxLength(40)
                .IsUnicode(false)
                .HasComment("From Location Landing Type")
                .HasColumnName("FROMLANDRTYPE");
            entity.Property(e => e.Fromclearlance)
                .HasMaxLength(40)
                .IsUnicode(false)
                .HasComment("From Clearlance")
            ...
            entity.Property(e => e.Tolocationtype)
                .HasMaxLength(40)
                .IsUnicode(false)
                .HasComment("To Location Type")
                .HasColumnName("TOLOCATIONTYPE");
            entity.Property(e => e.Tolandtype)
                .HasMaxLength(40)
                .IsUnicode(false)
                .HasComment("To Location Landing Type")
                .HasColumnName("TOLANDRTYPE");
            entity.Property(e => e.Toclearlance)
                .HasMaxLength(40)
                .IsUnicode(false)
                .HasComment("To Clearlance")
