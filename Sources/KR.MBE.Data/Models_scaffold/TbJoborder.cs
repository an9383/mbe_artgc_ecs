...
/// <summary>
/// TOS로부터 수신한 Job Order의 현재 상태 및 진행 관리
/// </summary>
public partial class TbJoborder
{
    /// <summary>
    /// Job Order ID
    /// </summary>
    ...
    /// <summary>
    /// From Location Landing Type
    /// </summary>
    public string? Fromlandtype { get; set; }

    /// <summary>
    /// From Location Clearlance
    /// </summary>
    public string? Fromclearlance { get; set; }
    ...
    /// <summary>
    /// To Location Landing Type
    /// </summary>
    public string? Tolandtype { get; set; }

    /// <summary>
    /// To Location Clearlance
    /// </summary>
    public string? Toclearlance { get; set; }
