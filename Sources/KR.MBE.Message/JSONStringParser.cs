...
namespace KR.MBE.Message
{
    ...
    public class JSONStringParser
    {
        ...
        public static void FlattenJStringData(JObject jObject, Dictionary<string, string> flatDictionary, string prefix)
        {
            foreach (var property in jObject.Properties())
            {
                ...
                {
                    FlattenJStringData(nestedObject, flatDictionary, key);
                }
                else if (property.Value is JArray nestedArray)
                {
                    ...
                    foreach (var item in nestedArray)
                    {
                        ...
                        {
                            FlattenJStringData(nestedArrayObject, flatDictionary, $"{key}[{index}]");
                        }
                        else
                        {
                            flatDictionary[$"{key}[{index}]"] = item.ToString();
                        }
                        index++;
                    }
                }
                ...
                {
                    flatDictionary[key] = property.Value.ToString();
                }
            }
        }
