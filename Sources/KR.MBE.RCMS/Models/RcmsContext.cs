...
public partial class RcmsContext : DbContext
{
    ...
    public virtual DbSet<TbTransform> TbTransforms { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=220.117.185.138,8513;Database=RCMS;User Id=sa;Password=%wave1628;TrustServerCertificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<TbEquipment>(entity =>
        {
            ...
            entity.Property(e => e.Gantryoffset)
                .HasDefaultValue(0)
                .HasColumnName("GANTRYOFFSET");
            entity.Property(e => e.Gantryscale)
                .HasDefaultValue(1.0)
                .HasColumnName("GANTRYSCALE");
            entity.Property(e => e.Hoistoffset)
                .HasDefaultValue(0)
                .HasColumnName("HOISTOFFSET");
            entity.Property(e => e.Hoistscale)
                .HasDefaultValue(1.0)
                .HasColumnName("HOISTSCALE");
            ...
            entity.Property(e => e.Trolleyoffset)
                .HasDefaultValue(0)
                .HasColumnName("TROLLEYOFFSET");
            entity.Property(e => e.Trolleyscale)
                .HasDefaultValue(1.0)
                .HasColumnName("TROLLEYSCALE");
            entity.Property(e => e.Useflag)
                .HasMaxLength(40)
                .IsUnicode(false)
                .HasComment("사용여부")
        ...
        modelBuilder.Entity<TbTransform>(entity =>
        {
            entity.HasKey(e => new { e.Id, e.Type }).HasName("TB_TRANSFORM_PK");

            entity.ToTable("TB_TRANSFORM");
